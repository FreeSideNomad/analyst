...
- [x] **Relational features, temporal splits & classification** `id:relational-temporal-models` priority:6 status:shipped area:models → feature:guided-graph-authoring
...
- [x] **Relational graph (GNN) model backend** `id:relational-graph-backend` priority:9 status:shipped area:models → feature:relational-graph-models
